...
(function () {
  ...
  function initManpowerQuote() {
    ...
    function update() {
      ...
      if (budgetVal) budgetVal.innerHTML = '<span class="sar" aria-label="Saudi Riyal">\u20C1<span class="sar-fallback">SAR</span></span> ' + toArabicNumbers(String(budget));

      if (totalVal) totalVal.innerHTML = '<span class="sar" aria-label="Saudi Riyal">\u20C1<span class="sar-fallback">SAR</span></span> ' + toArabicNumbers(String(budget * workers));
      var wxLabel = (translations[currentLang] && translations[currentLang].mq_workers_x) || 'workers \u00d7';
      if (totalBreakdown) totalBreakdown.innerHTML = toArabicNumbers(String(workers)) + ' ' + wxLabel + ' <span class="sar" aria-label="Saudi Riyal">\u20C1<span class="sar-fallback">SAR</span></span> ' + toArabicNumbers(String(budget));
    }
