...
(function () {
  ...
  const translations = {
    en: {
      ...
      svc4_item1: 'IT Staffing',
      svc4_item2: 'Engineering Resources',
      svc4_item3: 'Project Teams',
      svc5_title: 'Hardware & Software',
      svc5_desc: 'Procurement and deployment of enterprise-grade hardware and licensed software solutions.',
      svc5_item1: 'Enterprise Hardware',
      svc5_item2: 'Software Licensing',
      svc5_item3: 'Asset Management',
      svc6_title: 'Cloud Services',
    ...
    ar: {
      ...
      svc6_title: 'الخدمات السحابية',
      svc6_desc: 'بنية سحابية قابلة للتطوير مع الهجرة والإدارة والتحسين على مزودي الخدمات الرائدين.',
      svc6_item1: 'AWS و Azure و Google Cloud',
      svc6_item2: 'الهجرة وتحديث الأعباء',
      svc6_item3: 'العمليات المُدارة وتحسين التكلفة',
  ...
  function typeWriter() {
    ...
    if (!el) return;
    var words = ['IT', 'Engineering', 'Security', 'Cloud', 'MDM'];
    var wordIdx = 0;
    var charIdx = 0;
    var deleting = false;
    var speed = 120;
